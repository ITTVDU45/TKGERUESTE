...
<details class="faq-item">
  <summary><strong>Wie lange dauert der Aufbau eines Fassadengerüsts?</strong></summary>
  <p>Das hängt von der Objektgröße ab. Ein Einfamilienhaus (ca. 30–40 m Fassadenlänge, 2 Lagen) ist häufig an einem Tag eingerüstet. Größere Mehrfamilienhäuser benötigen meist 1–2 Tage. Umfangreiche Konstruktionen dauern entsprechend länger; die genaue Dauer nennen wir im Vor‑Ort‑Termin.</p>
</details>

<details class="faq-item">
  <summary><strong>Brauche ich eine Genehmigung für das Gerüst?</strong></summary>
  <p>Ja, sobald das Gerüst Teile des öffentlichen Raums (Gehweg/Straße) nutzt. In diesem Fall ist eine Sondernutzungserlaubnis der Kommune nötig — wir unterstützen und übernehmen die Antragstellung (z. B. Stadt Duisburg). Steht das Gerüst ausschließlich auf Ihrem Privatgrund, ist in der Regel keine Genehmigung erforderlich.</p>
</details>

<details class="faq-item">
  <summary><strong>Was kostet ein Fassadengerüst ungefähr?</strong></summary>
  <p>Die Preise variieren. Als grober Richtwert gelten 5–15 € / m² (inkl. Basis‑Mietzeit). Konkrete Kosten hängen von Fläche, Höhe, Mietdauer, Zugang und Sonderteilen ab — wir erstellen ein transparentes Festpreis‑Angebot.</p>
</details>

<details class="faq-item">
  <summary><strong>Was passiert bei schlechtem Wetter?</strong></summary>
  <p>Leichter Regen: Wetterschutz/Planen möglich. Bei Sturm: Sicherheit hat Vorrang — ggf. Arbeitspausen oder zusätzliche Sicherungsmaßnahmen.</p>
</details>

<details class="faq-item">
  <summary><strong>Kann das Gerüst länger stehenbleiben?</strong></summary>
  <p>Ja. Verlängerungen sind unkompliziert — bitte informieren Sie uns rechtzeitig, damit wir Verfügbarkeit und Konditionen prüfen können.</p>
</details>

👉 **Jetzt anrufen und Termin vereinbaren**`,
    metaTitle: 'Fassadengerüst planen in Duisburg & NRW – TK Gerüste GmbH',
    metaDescription: 'Fassadengerüst planen in Duisburg & NRW: Kosten, Ablauf, Sicherheit und Checkliste. Kostenfreie Vor‑Ort‑Beratung in Duisburg.',
    thumb: '/assets/imgs/project/projektbild16.jpeg'
  },
  {
