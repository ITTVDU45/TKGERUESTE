      ...
      <div className="container-fluid bg-color-1">
         <div className="header-top">
            <div className="header-top-contact-info">
               <span className="email p-relative"><Link href="mailto:info@tk-gerueste.de">info@tk-gerueste.de</Link></span>
               <span className="time p-relative">Öffnungszeiten: Montag - Samstag 08:Uhr - 17 Uhr</span>
            </div>
