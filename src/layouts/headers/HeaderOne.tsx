...
// use public path for logo so PNG can be swapped without breaking build
...
const HeaderOne = () => {
   ...
   return (
      <>
         <header>
            <div id="header-sticky" className={`header-area header-style-two ${sticky ? "sticky" : ""}`} style={{ background: 'white', boxShadow: '0 6px 18px rgba(16,32,57,0.08)' }}>
                     ...
                     <div className="header-main">
                        <div className="header-left">
                           <div className="header-logo">
                              <Link href="/">
                                 <Image src="/assets/imgs/logo/tkgeruestelogo.png" alt="header logo" width={220} height={72} style={{ width: 'auto', height: 'auto' }} />
                              </Link>
                           </div>
                        </div>
                           ...
                           <div className="header-action">
                              <div className="header-link-1">
                                 ...
                                 <div className="content">
                                    ...
                                    <h6><Link href="tel:+491782686000">+49 178 268 60 00</Link></h6>
                                 </div>
                              </div>
                           </div>
